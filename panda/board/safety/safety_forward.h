...
uint16_t candidate_fp[2][20][3] = {
  ...
  { {2,832,8}, {0,339,8},{0,356,4},{0,593,8},{0,608,8},{0,897,8},{0,902,8},{0,916,8},{0,1078,4},{0,1170,8},{0,1265,4},{0,1312,8},{0,1345,8},{0,1419,8} },
  // Hyundai old Giraffe (camera = bus1)
  { {1,832,8}, {0,339,8},{0,356,4},{0,593,8},{0,608,8},{0,897,8},{0,902,8},{0,916,8},{0,1078,4},{0,1170,8},{0,1265,4},{0,1312,8},{0,1345,8},{0,1419,8} }
};
