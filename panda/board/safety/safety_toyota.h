...
// global torque limit
const int TOYOTA_MAX_TORQUE = 1500;       // max torque cmd allowed ever rav4 starts to complain at 1530 with an lka state of 25

// rate based torque limit + stay within actually applied
// packet is sent at 100hz, so this limit is 1000/sec
const int TOYOTA_MAX_RATE_UP = 20;        // ramp up slow
